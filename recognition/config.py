...
## quyan modified at 2019.7.24: add r34
network.r34 = edict()
...
## quyan modified at 2019.7.24: add casia daset
dataset.casia = edict()
...
dataset.casia.val_targets = ['lfw', 'calfw', 'agedb_30', 'cfp_ff', 'cfp_fp', 'cplfw']
...
## modified by quyan at 2019.7.24, change log internal from 2000 to 1000 
