...
def parse_args():
    ...
    parser.add_argument('--target', type=str, default='lfw,cfp_fp,agedb_30,cplfw,calfw', help='verification targets')
...
def get_symbol(args, arg_params, aux_params):
    ...
    ## output the network structure to plot.gv.pdf
    # mx.viz.plot_network(symbol=out).view()
